...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Flight> flights = session.createQuery("from Flight f "
            			+ "where f.origin.country='USA' "
        ...
        try {
            ...
            List<Flight> flights = session.createQuery("from Flight f where "
            			+ "f.airline.name<>'Star Alliance' and "
            			+ "f.airplane.model='747'").list();
        ...
        try {
            ...
            @SuppressWarnings("unchecked")
            List<Flight> flights = session.createQuery("from Flight f "
            			+ "where f.departureDate = '2009-08-07' and "
            			+ "f.departureTime<'12:00:00'").list();
